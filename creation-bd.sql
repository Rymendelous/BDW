...
CREATE TABLE accompagne(
    PRIMARY KEY(id,idConstruction,idPhoto),
    id serial,
    idConstruction INTEGER NOT NULL,
    idPhoto INTEGER NOT NULL
);
...
CREATE TABLE se_divise(
    PRIMARY KEY(numTour,id,idPartie),
    numTour INTEGER NOT NULL,
    id serial,
    idPartie INTEGER NOT NULL
);
...
CREATE TABLE joue(
    PRIMARY KEY(numTour,id,idJoueur),
    numTour INTEGER NOT NULL,
    id serial,
    idJoueur INTEGER NOT NULL
);
...
ALTER TABLE piece ADD FOREIGN KEY (idCritere) REFERENCES CRITERE (idCritere);

ALTER TABLE USINE ADD FOREIGN KEY (id) REFERENCES piece (id);
...
ALTER TABLE fabrique_un_type_de ADD FOREIGN KEY (id) REFERENCES piece (id);
...
ALTER TABLE est_assemble ADD FOREIGN KEY (id) REFERENCES piece (id);
...
ALTER TABLE accompagne ADD FOREIGN KEY (id) REFERENCES piece (id);
...
INSERT INTO DATEF VALUES ('2023-01-01');
INSERT INTO DATEF VALUES ('2023-02-01');
INSERT INTO DATEF VALUES ('2023-03-01');
INSERT INTO DATEF VALUES ('2023-04-01');
INSERT INTO DATEF VALUES ('2023-05-01');

INSERT INTO USINE (idU, ville, pays, dateFabrication) VALUES (1, 'Paris', 'France', '2023-01-01');
INSERT INTO USINE (idU, ville, pays, dateFabrication) VALUES (2, 'Lyon', 'France', '2023-02-01');
INSERT INTO USINE (idU, ville, pays, dateFabrication) VALUES (3, 'Berlin', 'Allemagne', '2023-03-01');
INSERT INTO USINE (idU, ville, pays, dateFabrication) VALUES (4, 'Madrid', 'Espagne', '2023-04-01');
INSERT INTO USINE (idU, ville, pays, dateFabrication) VALUES (5, 'Rome', 'Italie', '2023-05-01');

INSERT INTO CRITERE VALUES (1, 'Critère 1', 'Commentaire 1');
INSERT INTO CRITERE VALUES (2, 'Critère 2', 'Commentaire 2');
INSERT INTO CRITERE VALUES (3, 'Critère 3', 'Commentaire 3');
INSERT INTO CRITERE VALUES (4, 'Critère 4', 'Commentaire 4');
INSERT INTO CRITERE VALUES (5, 'Critère 5', 'Commentaire 5');

INSERT INTO CONSTRUCTION VALUES (1, 'Construction 1', 'Thème 1', 'Description 1', 2020, 10.0, 10.0, 10.0);
INSERT INTO CONSTRUCTION VALUES (2, 'Construction 2', 'Thème 2', 'Description 2', 2021, 20.0, 20.0, 20.0);
INSERT INTO CONSTRUCTION VALUES (3, 'Construction 3', 'Thème 3', 'Description 3', 2022, 30.0, 30.0, 30.0);
INSERT INTO CONSTRUCTION VALUES (4, 'Construction 4', 'Thème 4', 'Description 4', 2023, 40.0, 40.0, 40.0);
INSERT INTO CONSTRUCTION VALUES (5, 'Construction 5', 'Thème 5', 'Description 5', 2024, 50.0, 50.0, 50.0);

INSERT INTO OFFICIEL VALUES (1, '7ans', 19.99, 'Officiel 1', 1);
INSERT INTO OFFICIEL VALUES (2, '12ans', 29.99, 'Officiel 2', 2);
INSERT INTO OFFICIEL VALUES (3, '5ans', 39.99, 'Officiel 3', 3);
INSERT INTO OFFICIEL VALUES (4, '10ans', 49.99, 'Officiel 4', 4);
INSERT INTO OFFICIEL VALUES (5, '15ans', 59.99, 'Officiel 5', 5);

INSERT INTO AMATEUR VALUES ('Amateur 1', 'Licence 1', 1);
INSERT INTO AMATEUR VALUES ('Amateur 2', 'Licence 2', 2);
INSERT INTO AMATEUR VALUES ('Amateur 3', 'Licence 3', 3);
INSERT INTO AMATEUR VALUES ('Amateur 4', 'Licence 4', 4);
INSERT INTO AMATEUR VALUES ('Amateur 5', 'Licence 5', 5);

INSERT INTO ETAPES VALUES (1, 'Image 1', 'Instruction 1');
INSERT INTO ETAPES VALUES (2, 'Image 2', 'Instruction 2');
INSERT INTO ETAPES VALUES (3, 'Image 3', 'Instruction 3');
INSERT INTO ETAPES VALUES (4, 'Image 4', 'Instruction 4');
INSERT INTO ETAPES VALUES (5, 'Image 5', 'Instruction 5');

INSERT INTO PHOTO VALUES (1, 'Photo 1', 'Description Photo 1', '/path/to/photo1.jpg');
INSERT INTO PHOTO VALUES (2, 'Photo 2', 'Description Photo 2', '/path/to/photo2.jpg');
INSERT INTO PHOTO VALUES (3, 'Photo 3', 'Description Photo 3', '/path/to/photo3.jpg');
INSERT INTO PHOTO VALUES (4, 'Photo 4', 'Description Photo 4', '/path/to/photo4.jpg');
INSERT INTO PHOTO VALUES (5, 'Photo 5', 'Description Photo 5', '/path/to/photo5.jpg');

INSERT INTO TOUR VALUES (1, 'Action 1');
INSERT INTO TOUR VALUES (2, 'Action 2');
INSERT INTO TOUR VALUES (3, 'Action 3');
INSERT INTO TOUR VALUES (4, 'Action 4');
INSERT INTO TOUR VALUES (5, 'Action 5');

INSERT INTO JOUEUR VALUES (1, 'Chloé', '2004-01-01', 'avatar1.png');
INSERT INTO JOUEUR VALUES (2, 'Jules', '2003-01-02', 'avatar2.png');
INSERT INTO JOUEUR VALUES (3, 'Bob', '2023-01-03', 'avatar3.png');
INSERT INTO JOUEUR VALUES (4, 'Jean', '2023-01-04', 'avatar4.png');
INSERT INTO JOUEUR VALUES (5, 'Julie', '2023-01-05', 'avatar5.png');

INSERT INTO PARTIE VALUES (1, '2023-01-01', '2023-01-02');
INSERT INTO PARTIE VALUES (2, '2023-01-03', '2023-01-04');
INSERT INTO PARTIE VALUES (3, '2023-01-05', '2023-01-06');
INSERT INTO PARTIE VALUES (4, '2023-01-07', '2023-01-08');
INSERT INTO PARTIE VALUES (5, '2023-01-09', '2023-01-10');

INSERT INTO PARAMETRE VALUES (1, 'Propriété 1', 'Valeur 1');
INSERT INTO PARAMETRE VALUES (2, 'Propriété 2', 'Valeur 2');
INSERT INTO PARAMETRE VALUES (3, 'Propriété 3', 'Valeur 3');
INSERT INTO PARAMETRE VALUES (4, 'Propriété 4', 'Valeur 4');
INSERT INTO PARAMETRE VALUES (5, 'Propriété 5', 'Valeur 5');

INSERT INTO est_configure_selon VALUES (1, 1, '00:30:00');
INSERT INTO est_configure_selon VALUES (2, 2, '01:00:00');
INSERT INTO est_configure_selon VALUES (3, 3, '01:30:00');
INSERT INTO est_configure_selon VALUES (4, 4, '02:00:00');
INSERT INTO est_configure_selon VALUES (5, 5, '02:30:00');

INSERT INTO fabrique_un_type_de VALUES (1, '2023-01-01', 100);
INSERT INTO fabrique_un_type_de VALUES (2, '2023-02-01', 200);
