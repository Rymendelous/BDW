...
CREATE TABLE dateF(
    dateFabrication date PRIMARY KEY 
);
...
CREATE TABLE usine(
    ...
    ville varchar(50),
    pays varchar(50),
    id integer REFERENCES piece(id),
    dateFabrication date REFERENCES dateF(dateFabrication)
);

CREATE TABLE construction(
    idConstruction serial PRIMARY KEY,
    nomC varchar(50),
    theme varchar(50),
    description text,
...
CREATE TABLE officiel(
    ...
    prix float,
    nom varchar(50),
    idConstruction integer REFERENCES construction(idConstruction)
);

CREATE TABLE amateur(
    nom_amateur varchar(50) PRIMARY KEY,
    licence varchar(20),
    idConstruction integer REFERENCES construction(idConstruction)
);

CREATE TABLE etapes(
    numE serial PRIMARY KEY,
    image text,
    instruction text,
    idConstruction integer REFERENCES construction(idConstruction)
);
...
CREATE TABLE partie (
    ...
    dateDeb date,
    dateFin date,
    idConfiguration integer REFERENCES configuration(idConfiguration)
);
...
CREATE TABLE fabrique_un_type_de (
    ...
    id integer REFERENCES piece(id),
    dateFabrication date REFERENCES dateF(dateFabrication),
    PRIMARY KEY (id, dateFabrication)
);

CREATE TABLE est_remplace_par(
);

CREATE TABLE est_assemble(
    idConstruction integer REFERENCES construction(idConstruction),
    id integer REFERENCES piece(id),
    PRIMARY KEY (idConstruction, id)
);

CREATE TABLE suit (
    idConstruction integer REFERENCES construction(idConstruction),
    numE integer REFERENCES etapes(numE),
...
CREATE TABLE accompagne (
    ...
    PRIMARY KEY (idConstruction, id, idPhoto)
);
...
CREATE TABLE se_divise (
    numTour integer REFERENCES tour(numTour),
    idPartie integer REFERENCES partie(idPartie),
...
INSERT INTO legos.critere VALUES (DEFAULT, 'Couleur', 'Critère de couleur des pièces');
INSERT INTO legos.critere VALUES (DEFAULT, 'Taille', 'Critère de taille des pièces');
INSERT INTO legos.critere VALUES (DEFAULT, 'Type de pièce', 'Type de pièce (ex: brique, plaque)');
INSERT INTO legos.critere VALUES (DEFAULT, 'Élément décoratif', 'Si la pièce a un élément décoratif');
INSERT INTO legos.critere VALUES (DEFAULT, 'Compatibilité', 'Compatibilité avec dautres sets');

INSERT INTO legos.dateF VALUES ('2023-01-15');
INSERT INTO legos.dateF VALUES ('2023-05-20');
INSERT INTO legos.dateF VALUES ('2022-11-10');
INSERT INTO legos.dateF VALUES ('2023-03-03');
INSERT INTO legos.dateF VALUES ('2024-07-25');

INSERT INTO legos.usine VALUES (DEFAULT, 'Paris', 'France', 1, '2023-01-15');
INSERT INTO legos.usine VALUES (DEFAULT, 'Berlin', 'Allemagne', 2, '2023-05-20');
INSERT INTO legos.usine VALUES (DEFAULT, 'New York', 'USA', 3, '2022-11-10');
INSERT INTO legos.usine VALUES (DEFAULT, 'Tokyo', 'Japon', 4, '2023-03-03');
INSERT INTO legos.usine VALUES (DEFAULT, 'Moscou', 'Russie', 5, '2024-07-25');

INSERT INTO legos.construction VALUES (DEFAULT, 'Bâtiment Futuriste', 'Futurisme', 'Un bâtiment représentant le futur.', 2025, 20.5, 15.0, 10.0);
INSERT INTO legos.construction VALUES (DEFAULT, 'Château Médiéval', 'Historique', 'Un château inspiré du Moyen Âge.', 2022, 30.0, 25.0, 15.0);
INSERT INTO legos.construction VALUES (DEFAULT, 'Pont Suspendu', 'Ingénierie', 'Un pont suspendu au-dessus dune vallée.', 2023, 50.0, 10.0, 5.0);
INSERT INTO legos.construction VALUES (DEFAULT, 'Vaisseau Spatial', 'Science-fiction', 'Un vaisseau spatial intergalactique.', 2024, 40.0, 15.0, 12.0);
INSERT INTO legos.construction VALUES (DEFAULT, 'Maison Écologique', 'Écologie', 'Une maison conçue pour être écologique.', 2023, 12.0, 8.0, 6.0);


INSERT INTO legos.officiel VALUES (DEFAULT, 10, 49.99, 'Set A', 1);
INSERT INTO legos.officiel VALUES (DEFAULT, 8, 29.99, 'Set B', 2);
INSERT INTO legos.officiel VALUES (DEFAULT, 12, 39.99, 'Set C', 3);
INSERT INTO legos.officiel VALUES (DEFAULT, 15, 59.99, 'Set D', 4);
INSERT INTO legos.officiel VALUES (DEFAULT, 6, 19.99, 'Set E', 5);


INSERT INTO legos.amateur VALUES ('Alice', 'AM123', 1);
INSERT INTO legos.amateur VALUES ('Bob', 'AM456', 2);
INSERT INTO legos.amateur VALUES ('Charlie', 'AM789', 3);
INSERT INTO legos.amateur VALUES ('David', 'AM101', 4);
INSERT INTO legos.amateur VALUES ('Eve', 'AM202', 5);


INSERT INTO legos.etapes VALUES (DEFAULT, 'image1.png', 'Étape 1: Assemblez les pièces.', 1);
INSERT INTO legos.etapes VALUES (DEFAULT, 'image2.png', 'Étape 2: Fixez la base.', 2);
INSERT INTO legos.etapes VALUES (DEFAULT, 'image3.png', 'Étape 3: Ajoutez les murs.', 3);
INSERT INTO legos.etapes VALUES (DEFAULT, 'image4.png', 'Étape 4: Terminez le toit.', 4);
INSERT INTO legos.etapes VALUES (DEFAULT, 'image5.png', 'Étape 5: Décorez votre modèle.', 5);


INSERT INTO legos.photo VALUES (DEFAULT, 'Photo A', 'Description de la photo A', 'chemin/photoA.jpg');
INSERT INTO legos.photo VALUES (DEFAULT, 'Photo B', 'Description de la photo B', 'chemin/photoB.jpg');
INSERT INTO legos.photo VALUES (DEFAULT, 'Photo C', 'Description de la photo C', 'chemin/photoC.jpg');
INSERT INTO legos.photo VALUES (DEFAULT, 'Photo D', 'Description de la photo D', 'chemin/photoD.jpg');
INSERT INTO legos.photo VALUES (DEFAULT, 'Photo E', 'Description de la photo E', 'chemin/photoE.jpg');


INSERT INTO legos.tour VALUES (DEFAULT, 'Assembler une brique', 1);
INSERT INTO legos.tour VALUES (DEFAULT, 'Peindre la pièce', 2);
INSERT INTO legos.tour VALUES (DEFAULT, 'Vérifier la compatibilité', 3);
INSERT INTO legos.tour VALUES (DEFAULT, 'Ajouter un élément décoratif', 4);
INSERT INTO legos.tour VALUES (DEFAULT, 'Retirer une pièce', 5);


INSERT INTO legos.joueur VALUES (DEFAULT, 'Lucas', '2023-01-01', 'avatar1.png');
INSERT INTO legos.joueur VALUES (DEFAULT, 'Sophie', '2023-02-15', 'avatar2.png');
INSERT INTO legos.joueur VALUES (DEFAULT, 'Tom', '2023-03-20', 'avatar3.png');
INSERT INTO legos.joueur VALUES (DEFAULT, 'Anna', '2023-04-25', 'avatar4.png');
INSERT INTO legos.joueur VALUES (DEFAULT, 'Max', '2023-05-30', 'avatar5.png');


INSERT INTO legos.partie VALUES (DEFAULT, '2023-06-01', '2023-06-02', 1);
INSERT INTO legos.partie VALUES (DEFAULT, '2023-07-01', '2023-07-02', 2);
INSERT INTO legos.partie VALUES (DEFAULT, '2023-08-01', '2023-08-02', 3);
INSERT INTO legos.partie VALUES (DEFAULT, '2023-09-01', '2023-09-02', 4);
INSERT INTO legos.partie VALUES (DEFAULT, '2023-10-01', '2023-10-02', 5);


INSERT INTO legos.configuration VALUES (DEFAULT, 'Mode de jeu', 'Classique', '1 hour');
INSERT INTO legos.configuration VALUES (DEFAULT, 'Niveau de difficulté', 'Facile', '30 minutes');
INSERT INTO legos.configuration VALUES (DEFAULT, 'Nombre de joueurs', '2', '0 minutes');
INSERT INTO legos.configuration VALUES (DEFAULT, 'Temps de construction', '3 heures', '3 hours');
INSERT INTO legos.configuration VALUES (DEFAULT, 'Éléments à collectionner', '5', '0 minutes');
